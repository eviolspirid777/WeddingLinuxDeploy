  ...
  const events = [
    {
      ...
      description:
        "Официальная роспись в ЗАГСе на Солдате! \n\n*Невеста в белом, жених — в пиджаке (и, надеемся, с бабочкой). Родители — в слезах, друзья — в восторге, а любовь — в документах!*",
      icon: Clock,
    ...
    {
      time: "16:00",
      title: "Сбор эскадрильи родных и близких",
      description:
        "Прибытие гостей на торжество! *Вас ждут улыбки, бокалы и первые объятия. Не опаздывайте — иначе рискуете пропустить момент!*",
      icon: Sparkles,
    ...
    {
      time: "17:00–23:00",
      title: "Бал безудержного веселья",
      description:
        "Развлекательная программа в полном разгаре! Танцы, конкурсы, тосты, смех до упаду, фото на память (и пару на века), кулинарные восторги и музыкальные сюрпризы. Совет: наденьте удобную обувь — танцпол будет горячим, даже если кондиционер работает на полную!",
      icon: Music,
    ...
    },
    {
      ...
      description:
        "Спокойная, душевная музыка под звёздами. Время для тёплых разговоров, последних танцев в паре и ностальгических вздохов: «Как же быстро пролетел этот день…». А мы — уже мечтаем о завтрашнем утре… вместе.",
      icon: MoonStar,
